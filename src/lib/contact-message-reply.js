...
${plainReply}
${followUpUrl ? `
Vill du skriva tillbaka? Använd den här länken så hamnar svaret i samma ärende:
${followUpUrl}

Ett vanligt mejlsvar till vår supportadress syns inte i inkorgen.` : ''}
...
${config.email.fromName}`;
  ...
  const html = `
    <div style="font-family: sans-serif; max-width: 520px; margin: 0 auto; color: #1B2340;">
      ...
      ${followUpUrl ? `<p style="margin-top: 20px; line-height: 1.5;">Vill du skriva tillbaka? <a href="${escapeHtml(followUpUrl)}" style="color: #C4851A; font-weight: 600;">Svara i ärendet</a> så ser vi det direkt. Ett vanligt mejlsvar till vår supportadress syns inte i inkorgen.</p>` : ''}
