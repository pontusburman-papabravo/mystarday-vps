...
const familyPremiumGrantRouter = require('./admin/family-premium-grant');
...
const forDigOutcomeFollowupRouter = require('./admin/for-dig-outcome-followup');
...
router.use(familyPremiumGrantRouter);
...
router.use(forDigOutcomeFollowupRouter);
