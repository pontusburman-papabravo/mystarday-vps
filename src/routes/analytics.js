...
const ALLOWED_CLIENT_EVENTS = new Set([
  ...
  'activation_step_error',
  'activation_problem_report_opened',
  'activation_problem_report_submitted',
  'activation_problem_report_failed',
  'activation_schedule_load_started',
  'activation_schedule_load_succeeded',
  'activation_schedule_load_failed',
  'activation_schedule_retry',
  'activation_continue_anyway',
