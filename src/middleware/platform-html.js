...
const MAGIC_VERSION = '36'; // Bump when parent-magic-common / dashboard-magic CSS changes (native WebView cache bust)
...
function injectPlatformHtml(body, reqPath, req) {
  ...
  headParts.push(
    ...
    '<script src="/js/api-error-i18n.js?v=' + RELEASE_TAG + '"><\/script>',
