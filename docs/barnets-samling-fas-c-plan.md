...
**Status:** **Klar** — C1–C7 · `test:gate` grön · bygger på #606  
**Epic:** GitHub **#585** (manuellt: stäng epic)  
...
- [x] C1–C7 acceptance criteria
- [x] `npm run test:gate` grön
- [x] `npm run check:css` (SW v545)
- [x] SW bump
- [x] Inga redeem/API/DB-ändringar
- [x] Godkänd/Genomförd follow-up dokumenterad (ej DB i Fas C)

### Levererat i gate-ON (`child-treasure-present.js`)

| Del | Innehåll |
|-----|----------|
| C2 | Aktivt mål + tomstatus |
| C3 | Progress spendable saldo, bar, stjärngrid |
| C4 | Sparar · Kan lösas in · Väntar · Godkänd (flash) · Genomförd |
| C5 | Historik + tom historik |
| C6 | NPF-copy pass |
| C7 | `barnets-samling-treasure-v1.test.js` |
