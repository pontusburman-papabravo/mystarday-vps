...
**Alla gröna → TestFlight tillåten.** Android sprint **16+** kräver Gate 0 grön. **9B** kräver **Gate 24**. **Verifierad 10/10** kräver **Gate 25** (efter SSE + barn-wow — [`android.md`](../android.md) § Gate 25, app2 §16.6).
