...
**Status:** Operativ implementation spec (2026-07) — **IA authority:** `product-operating-system/00A` + ADR `14` §1  
**Referens (föräldrar):** [parent-hubs-index.md](parent-hubs-index.md)  
**Arkitektur:** [informationsarkitektur-barnapp.md](informationsarkitektur-barnapp.md) (historisk) · [barnmeny-v2.md](barnmeny-v2.md)  
...
**Canonical child places (POS):** Idag · Min värld · Familj. Tabellen nedan listar **shipped surfaces** — Skattkammaren är belöningsyta i stjärnloopen, inte en fjärde root.

| Värld / yta | Vision | Agent-uppdrag | Status |
|-------|--------|---------------|--------|
