...
| Kör-ID | QA-300-MERGE-2026-06-06-mq2s77g4 |
| Datum | 2026-06-06 |
...
Källor: extended=206, full=37, local=57, none=0
...
| QA-016 | ✅ pass | full | register primary |
| QA-017 | ✅ pass | local |  |
| QA-018 | ⚠️ partial | full | production — ingen verifyToken i svar |
| QA-019 | ⚠️ partial | extended | grace period — inloggad utan verify |
...
| QA-086 | ✅ pass | local |  |
| QA-087 | ⏭ skip | extended | radera barn — destruktivt |
| QA-088 | ⚠️ partial | extended | primary-only delete — kod |
...
| QA-197 | ⚠️ partial | full | add-parent direkt (ej e-postinbjudan) |
...
| QA-205 | ⏭ skip | extended | delete-account destruktivt |
