...
| # | Källfil | Beskrivning |
|---|---------|-------------|
| 1 | `APP-V2-KRAVSPEC.md` | App v2 — Kravspecifikation (takdokument) (~672 rader) |
...
## Ej inkluderade (för stora / parallella spår)

Kopiera separat vid behov:

| Fil | Rader (ca) | Varför ej här |
|-----|------------|---------------|
| `paket-v1.2-spec.md` | ~3700 | Paketdetaljer — refereras från kravspec |
| `for-dig-spec.md` | ~1200 | För dig roadmap V1–V5 |
| `kravspec-app-webb.md` | ~400 | Plattform & säkerhet (v1) |
| `tillvaxt-retention-krav.md` | ~400 | Tillväxt/KPI (ej ren v2-IA) |
| `admin-v2/ADMIN-V2-DELIVERY.md` | ~100 | Redan levererat |
