# Platform — TEMP samlingsdokument

> Genererat 2026-06-26 · **Börja med PRODUCT_BEHAVIOR_SPEC.md**

| # | Fil |
|---|-----|
| 1 | `VISION-2030.md` (~69 r) |
| 2 | `PRODUCT_BEHAVIOR_SPEC.md` (~813 r) |
...
| 8 | `vuxenmeny-v2-operations-checklist.md` (~416 r) |
| 9 | `informationsarkitektur-barnapp.md` (~352 r) |
| 10 | `separation-contract-barnapp.md` (~285 r) |
| 11 | `engineering-architecture-barnapp.md` (~517 r) |
| 12 | `implementation-plan-3-layers.md` (~131 r) |
| 13 | `magic-view-rollout.md` (~69 r) |
