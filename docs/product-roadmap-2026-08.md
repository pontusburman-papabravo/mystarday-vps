...
| R4.5 Native snabb-completion (widget) | **ENGINEERING COMPLETE** (rollout OFF) | Prod @ `7f0edfe8`; pilot flags: family allow bypasses global OFF (#938 pending); ATT removed — no cross-app tracking; iOS **1.3 (30)** / Android **1.3.0 (10)** | Native archive/AAB + physical pilot **BLOCKED** (Xcode/Android CI on Mac/Xcode Cloud) |
