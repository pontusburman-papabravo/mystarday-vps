...
| `memory-hall-scene` | Minnesrummet | `scene@2x.webp` (+ srcset) | `public/images/child/world/memory-hall/` | `child-memory-hall.js`, `memory-hall-asset-pipeline.js` | behöver iteration (v1 procedural) |
