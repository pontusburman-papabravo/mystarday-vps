...
**Status:** Produktkompass (godkänd 2026-07) — implementation enligt [mina-personer-agent-prompt.md](mina-personer-agent-prompt.md)  
...
> **Teknikagnostiskt.** Implementation följer [mina-personer-agent-prompt.md](mina-personer-agent-prompt.md).
