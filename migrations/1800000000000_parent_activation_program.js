/**
 * Parent activation program (7-day onboarding / 3-day reactivation).
 * Fas 1: schema only — enrollment hook in Fas 4.
 */
module.exports = {
  name: '1800000000000_parent_activation_program',
  ...
  down: async (client) => {
    await client.query('DROP TABLE IF EXISTS parent_seen_completion');
    await client.query('DROP TABLE IF EXISTS parent_activation_program');
  },
};
