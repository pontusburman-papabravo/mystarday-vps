...
const R2_PDF_PAGES = [
  ...
  },
  {
    ...
    slug: 'hygien',
    title: 'Hygiensschema PDF — mall med bildstöd',
    description: 'Gratis hygiensschema att skriva ut — tom mall och färdigt exempel.',
    downloads: [
      { href: '/resurser/pdf/hygiensschema.pdf', label: 'Hygiensschema — tom mall (PDF)' },
      { href: '/resurser/pdf/hygiensschema-exempel.pdf', label: 'Hygiensschema — exempel (PDF)' },
