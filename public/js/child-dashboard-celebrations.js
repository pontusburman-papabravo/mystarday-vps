...
(function () {
  ...
  function checkMilestones(total, completed) {
    ...
    const milestones = [
      { pct: 25, message: (typeof window.cpt === 'function' ? cpt('celebration.milestone25') : ''), emoji: '🌟', delay: 100 },
      { pct: 50, message: (typeof window.cpt === 'function' ? cpt('celebration.milestone50') : ''), emoji: '🎉', delay: 100 },
      { pct: 75, message: (typeof window.cpt === 'function' ? cpt('celebration.milestone75') : ''), emoji: '🚀', delay: 100 },
    ];
