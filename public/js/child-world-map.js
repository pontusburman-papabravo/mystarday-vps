...
(function () {
  ...
  function defaultMap() {
    return [
      ...
      { slug: 'laxor', icon: '📚', label: 'Läxbordet', href: '/child/play/laxor', unlocked: false, active: false },
      { slug: 'vardag', icon: '⭐', label: 'Mitt rum', href: '/child/play/vardag', unlocked: false, active: false },
    ];
  }
