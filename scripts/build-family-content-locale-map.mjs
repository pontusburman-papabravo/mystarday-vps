...
const EXTENDED_ACTIVITIES = {
  ...
  'Bada/Duscha': 'Bath or shower',
  'Borsta håret': 'Brush hair',
  'Duscha': 'Shower',
  'Film / Pyssel': 'Film or crafts',
  'Förskola': 'Preschool',
  'Läsa själv': 'Read by yourself',
  'Läxa': 'Homework',
  'Läxor / Pyssel': 'Homework or crafts',
  'Mata husdjuret': 'Feed the pet',
  'Musik/Dans': 'Music and dance',
  'Toalett': 'Toilet',
...
const EXTENDED_REWARDS = {
  ...
  'Extra saga vid läggdags': 'Extra story at bedtime',
  'Välja film på filmkväll': 'Choose a film on movie night',
  'Välja mellanmål': 'Choose a snack',
  'Frukost på sängen': 'Breakfast in bed',
  'Baka tillsammans': 'Baking together',
  'Stort valfritt önskemål': 'Big wish of your choice',
  'Restaurangbesök': 'Restaurant visit',
  'Pyssel-projekt tillsammans': 'Craft project together',
  'Familjens spelkväll': 'Family games night',
  'Utflykt till lekplats/park': 'Trip to playground or park',
  'Tältövernattning i vardagsrummet': 'Living-room tent sleepover',
  'Ny bok eller tidning': 'New book or magazine',
  'Biobesök med popcorn': 'Cinema trip with popcorn',
  'Utflykt (äventyrsbad/djurpark)': 'Trip (water park or zoo)',
  'Filmkväll': 'Movie night',
  'Baka ihop': 'Baking together',
  'Extra saga': 'Extra story',
  'Välja efterrätt': 'Choose dessert',
};
